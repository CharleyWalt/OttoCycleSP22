...
class steam():
    ...
    def new_calc(self, pressure, T=None, x=None, v=None, h=None, s=None, name=None ):
        """
        Recalculates a new state point within the same created steam object
        """
        self.p = pressure  # pressure - kPa
        self.T = T  # Temperature - degrees C
        self.x = x  # quality
...
def main():
    ...
    inlet.calc()
    inlet.print()
    inlet.new_calc(5000, x=0.5, name='new turbine inlet')
    inlet.print()
